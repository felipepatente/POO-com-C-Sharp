    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (triangulo.ETriangulo())
            {
                ...
                Console.WriteLine("As medidas {0}, {1} e {2} formam um {3}.",
                    triangulo.Medida1, triangulo.Medida2, triangulo.Medida3, tipoTriangulo[triangulo.GetTipo()]);
            }else
            {
...
/*Escreva um algoritmo que lê três medidas e verifica se elas formam um triângulo. Caso positivo, o algoritmo 
 * deve identificar qual o tipo de triângulo formado: equilátero, isósceles ou escaleno.

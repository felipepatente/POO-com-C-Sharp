...
namespace Alunos
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("O aluno {0} não passou com média {1}, pois está com frequência de {2}%",
...
/*
Escreva um algoritmo que lê o nome, a frequência e as notas de duas provas de um aluno e que mostra 
a seguinte mensagem, caso ele tenha passado:
...
Leve em conta que, se o aluno não tiver um mínimo de 75% de frequência, ele não passa, mesmo que tenha média 
acima de seis. Nesse caso, a mensagem deve ser:
